                ...
                <div class="mb-6">
                    <div class="flex justify-between">
                        ...
                        <x-button
                            ...
                            <a href="{{ route('customers.create') }}" class="flex items-center">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                @foreach ($customers as $customer)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $customer->ice ?? 'N/A' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $customer->patente ?? 'N/A' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $customer->id_fiscale ?? 'N/A' }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <a href="{{ route('customers.show', $customer->id) }}"
                                                class="inline-flex items-center text-green-600 hover:text-indigo-900">
